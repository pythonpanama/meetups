...
BLOG_AUTHOR = "Web Team de Python Panama"  # (translatable)
BLOG_TITLE = "Meetups de la comunidad Python Panama"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = ""
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://pythonpanama.github.io/meetups/"
BLOG_EMAIL = "pythonpa@aol.com"
BLOG_DESCRIPTION = "Sitio con las paginas de las reuniones de la comunidad Python Panama"  # (translatable)
